...
if __name__ == '__main__':
    ...
    eco_reservoirs = [
        100001, 100065, 100002, 100081, 100010, 100089, 100225, 100156,
        100167, 100120, 100091, 100017, 100104, 100100, 100257, 100171,
        100003, 100969, 100038, 100031, 100113, 100032, 100049, 101779,
        100163, 100275, 100115, 100053, 100118, 100153
    ]
